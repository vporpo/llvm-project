...
; RUN: opt -passes=sandbox-vectorizer -sbvec-vec-reg-bits=512 -sbvec-cost-threshold=-9999 -sbvec-force-seeds=stores -sbvec-max-rec-limit=0 -sbvec-max-rec-limit-at=0 %s -S | FileCheck %s --check-prefix=L0AT0
; RUN: opt -passes=sandbox-vectorizer -sbvec-vec-reg-bits=512 -sbvec-cost-threshold=-9999 -sbvec-force-seeds=stores -sbvec-max-rec-limit=1 -sbvec-max-rec-limit-at=0 %s -S | FileCheck %s --check-prefix=L1AT0
; RUN: opt -passes=sandbox-vectorizer -sbvec-vec-reg-bits=512 -sbvec-cost-threshold=-9999 -sbvec-force-seeds=stores -sbvec-max-rec-limit=2 -sbvec-max-rec-limit-at=0 %s -S | FileCheck %s --check-prefix=L2AT0

; RUN: opt -passes=sandbox-vectorizer -sbvec-vec-reg-bits=512 -sbvec-cost-threshold=-9999 -sbvec-force-seeds=stores -sbvec-max-rec-limit=0 -sbvec-max-rec-limit-at=1 %s -S | FileCheck %s --check-prefix=L0AT1
; RUN: opt -passes=sandbox-vectorizer -sbvec-vec-reg-bits=512 -sbvec-cost-threshold=-9999 -sbvec-force-seeds=stores -sbvec-max-rec-limit=1 -sbvec-max-rec-limit-at=1 %s -S | FileCheck %s --check-prefix=L1AT1
; RUN: opt -passes=sandbox-vectorizer -sbvec-vec-reg-bits=512 -sbvec-cost-threshold=-9999 -sbvec-force-seeds=stores -sbvec-max-rec-limit=2 -sbvec-max-rec-limit-at=1 %s -S | FileCheck %s --check-prefix=L2AT1
