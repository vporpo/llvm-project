...
;   |       |
;   S       S
define void @shuffle(ptr noalias %ptr) {
;
; VECTOR-LABEL: define void @shuffle(
...
; VECTOR-NEXT:    [[SHUF:%.*]] = shufflevector <2 x float> [[VECL]], <2 x float> poison, <2 x i32> <i32 1, i32 0>
; VECTOR-NEXT:    [[VEC:%.*]] = fsub <2 x float> [[VECL]], [[SHUF]]
; VECTOR-NEXT:    store <2 x float> [[VEC]], ptr [[PTR0]], align 4
; VECTOR-NEXT:    ret void
;
; SCALAR-LABEL: define void @shuffle(
