...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -O0 -mcpu=gfx1250 -amdgpu-enable-new-insert-waitcnts < %s | FileCheck --check-prefixes=GFX1250 %s
;
; XFAIL: *
; The new pass has multiple differences from the old pass in this test:
; 1. Wait instruction ordering differs (semantically equivalent but different order)
; 2. Missing s_wait_xcnt after scratch_store operations
; 3. Register allocation differences affect CHECK patterns
; These issues need to be investigated and fixed separately.
...
; GFX1250-DAG:     s_wait_storecnt 0x0
; GFX1250-DAG:     s_wait_xcnt 0x0
; GFX1250-DAG:     s_wait_loadcnt_dscnt 0x0
; GFX1250-DAG:     s_wait_kmcnt 0x0
; GFX1250:         global_atomic_add_u32 v0, v1, s[0:1] scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
...
; GFX1250-DAG:     s_wait_storecnt 0x0
; GFX1250-DAG:     s_wait_loadcnt_dscnt 0x0
; GFX1250:         global_atomic_add_u32 v0, v1, s[0:1] offset:4 scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    global_inv scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-DAG:     s_wait_storecnt 0x0
; GFX1250-DAG:     s_wait_loadcnt_dscnt 0x0
; GFX1250:         global_atomic_add_u32 v0, v1, s[0:1] offset:8 scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    global_inv scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_endpgm
...
; GFX1250-DAG:     s_wait_storecnt 0x0
; GFX1250-DAG:     s_wait_loadcnt_dscnt 0x0
; GFX1250:         global_atomic_add_u32 v0, v1, s[0:1] offset:12 scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    global_inv scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_endpgm
...
; GFX1250-DAG:     s_wait_storecnt 0x0
; GFX1250-DAG:     s_wait_loadcnt_dscnt 0x0
; GFX1250:         global_atomic_sub_u32 v0, v1, s[0:1] offset:4 scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    global_inv scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_mov_b32_e32 v1, 3
...
; GFX1250-DAG:     s_wait_storecnt 0x0
; GFX1250-DAG:     s_wait_loadcnt_dscnt 0x0
; GFX1250:         global_atomic_and_b32 v0, v1, s[0:1] offset:8 scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    global_inv scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_mov_b32_e32 v1, 4
...
; GFX1250-DAG:     s_wait_storecnt 0x0
; GFX1250-DAG:     s_wait_loadcnt_dscnt 0x0
; GFX1250:         global_atomic_or_b32 v0, v1, s[0:1] offset:12 scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    global_inv scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_endpgm
...
; GFX1250-DAG:     s_wait_xcnt 0x0
; GFX1250-DAG:     s_wait_loadcnt_dscnt 0x0
; GFX1250:         global_atomic_add_u32 v0, v1, s[2:3] scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    global_inv scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_mov_b32_e32 v1, 2
...
; GFX1250-DAG:     s_wait_storecnt 0x0
; GFX1250-DAG:     s_wait_loadcnt_dscnt 0x0
; GFX1250:         global_atomic_add_u32 v0, v1, s[2:3] offset:4 scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    global_inv scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-DAG:     s_wait_xcnt 0x0
; GFX1250-DAG:     s_wait_loadcnt_dscnt 0x0
; GFX1250:         global_atomic_add_u32 v0, v1, s[0:1] offset:16 scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    global_inv scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_endpgm
