...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx900 -amdgpu-enable-new-insert-waitcnts < %s | FileCheck %s -check-prefixes=SDAG
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck %s -check-prefixes=GISEL
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx900 -amdgpu-enable-new-insert-waitcnts < %s | FileCheck %s -check-prefixes=GISEL
...
; GISEL:         ds_read_b32 {{.*}}, v2
; GISEL:         ; wait_asyncmark(0)
; GISEL-NEXT:    ds_read_b32 {{.*}}, v2 offset:4
...
; GISEL:         global_load_dword {{.*}}, off lds
; GISEL:         ; asyncmark
; GISEL:         global_load_dword {{.*}}, off lds
; GISEL:         ; asyncmark
; GISEL:         ; wait_asyncmark(1)
...
; GISEL:         buffer_load_dword {{.*}} offen lds
; GISEL:         ; asyncmark
; GISEL:         buffer_load_dword {{.*}} offen lds
; GISEL:         ; asyncmark
; GISEL:         ; wait_asyncmark(1)
...
; GISEL:       ; %bb.0: ; %prolog
; GISEL:         global_load_dword v[0:1], off lds
; GISEL:         ; asyncmark
; GISEL:         global_load_dword v[0:1], off lds
; GISEL:         ; asyncmark
; GISEL:       .LBB4_1: ; %loop_body
; GISEL:         global_load_dword v[0:1], off lds
; GISEL:         ; asyncmark
; GISEL:         ; wait_asyncmark(2)
