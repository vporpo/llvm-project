...
; RUN: llc < %s -mtriple=amdgcn--amdhsa -mcpu=fiji -mattr=-flat-for-global -amdgpu-load-store-vectorizer=0 -amdgpu-enable-new-insert-waitcnts | FileCheck --check-prefix=GCN %s
