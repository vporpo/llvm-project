...
; RUN: llc -mtriple=amdgpu8.03-amd-amdhsa -mattr=+architected-flat-scratch < %s | FileCheck -check-prefixes=GFX8-ARCH-FLAT %s
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefixes=GFX9 %s
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa -mattr=+architected-flat-scratch < %s | FileCheck -check-prefixes=GFX9-ARCH-FLAT %s
; RUN: llc -mtriple=amdgpu9.42-amd-amdhsa -mattr=+architected-flat-scratch < %s | FileCheck -check-prefixes=GFX942-ARCH-FLAT %s
...
; GFX10-DAG:     s_waitcnt_vscnt null, 0x0
; GFX10-DAG:     s_waitcnt lgkmcnt(0)
